...
namespace LesGraphingCalc
{
    ...
    {
        private Loyc.Severity severity;
        private object ctx;
        private string msg;
        ...
        public LogException(Loyc.Severity severity, object ctx, double x)
        {
            this.type = "Math error";
            MessageBox.Show("Log(" + x + ") does not exsists", type, MessageBoxButtons.OK);
        }

        public LogException(Loyc.Severity severity, object ctx, string msg)
        {
